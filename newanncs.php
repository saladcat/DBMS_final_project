...
//连接数据库
	if(!empty($_POST['sub'])){
	   ...
	   $sql="insert into anncs (`anncs_title`,`anncs_content`,`anncs_time`) values ('$title', '$content',now())";
...
<html>
	...
	<body>
       ...
       <div class="container anncswp">
           <div class="add-form">
               <form method="POST" action="newanncs.php" name="ans" >
                   ...
                   <div style="float:right">
                       <input type="submit" value="儲存" name="sub" class="sub_index">
