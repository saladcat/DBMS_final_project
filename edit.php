...
if(!empty($_GET['view'])){
    ...
    if(!empty($_POST['sub'])){
        ...
        $q="insert into anncs (`anncs_title`,`anncs_content`,`anncs_time`) values ('$title', '$content',now())";
...
<div class="container announce-wrapper">
    ...
    <textarea name="content" rows="8" cols="92"><?php echo $rs_sql['anncs_content']?></textarea>
